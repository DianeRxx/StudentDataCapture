...
<html class= "detailsForm">
    ...
    <body>
        <form id=studentinfo class="app" action="details.php" method= "post"  >
            ...
            <p> Please enter the required information below. We will keep you informed of upcoming events. </p>
            <p>
            <button type="reset" value="Reset">Reset</button>
            </p>
            <fieldset>
                <legend>Contact Details</legend>
					Name: <input type="text" name= "name" placeholder="James Morgan" required pattern="[A-Za-z-0-9]+\s[A-Za-z-'0-9]+"><br>
    				Email: <input type="email" name= "user_email" placeholder="james@uni.com"><br>
    				Phone Number: <input type="number" name= "phonenumber" placeholder="07749751234" required>
            </fieldset>
            
            <fieldset>
                <legend>University Information</legend>
					University: <input type="text" name="university" placeholder="University of Strathclyde" required> <br>
					Degree: <input type="text" name= "degree" placeholder="MEng" required> <br>
					Course: <input type="text" name="course" placeholder="Computer Science" required> <br>
					Year of Study:   
